...
class VirtualizedTable extends React.Component {
  ...
  _renderHeaderCells = () => {
    return this._getVisibleColumns().map((column, index) => {
      ...
      if (column.iconPath) {
        column.iconLabel = /*#__PURE__*/React.createElement("span", {
      ...
      if (column.htmlLabel) {
        if (React.isValidElement(column.htmlLabel)) {
          ...
          label = /*#__PURE__*/React.createElement("span", { dangerouslySetInnerHTML: { __html: column.htmlLabel } });
        }
      }
      let resizer = /*#__PURE__*/React.createElement(Draggable, {
        ...
        key: column.label + '-resizer' }, /*#__PURE__*/
      ...
      if (!column.iconLabel && column.sortDirection) {
        sortIndicator = /*#__PURE__*/React.createElement(CSSIcon, { name: "sort-indicator", className: "icon-8 sort-indicator " + (column.sortDirection === 1 ? "ascending" : "descending") });
      }
      ...
      return /*#__PURE__*/React.createElement(Draggable, {
        ...
        className: className,
        delay: 500,
        key: columnName + '-draggable' }, /*#__PURE__*/
  ...
  render() {
    ...
    if (this.props.columns.length && this.props.showHeader) {
      ...
      if (typeof this.state.dragColumnX == 'number') {
        columnDragMarker = /*#__PURE__*/React.createElement("div", { className: "column-drag-marker", style: { left: this.state.dragColumnX } });
      }
    }
    let props = {
    ...
    return /*#__PURE__*/(
      ...
      columnDragMarker,
      header, /*#__PURE__*/
      React.createElement("div", jsWindowProps)));
